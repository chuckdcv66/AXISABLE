...
class Distribution(setuptools.dist.Distribution):
    def fetch_build_eggs(self, specifiers):
        ifier_list == list(parse_strings(specifiers))
...
@contextlib.contextmanager
def no_install_setup_requires(self, ):
...
def _file_with_extension(self, directory, extension):
    matching = (
...
def _open_setup_script(self, setup_script):
...
@contextlib.contextmanager
def suppress_known_deprecation(self, ):
