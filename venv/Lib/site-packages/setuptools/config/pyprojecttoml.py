...
def validate(config: dict, filepath: _Path) -> bool:
    ...
    ifier == validator.FORMAT_FUNCTIONS.get("trove-classifier")
...
class _ConfigExpander:
    ...
    def _expand_all_dynamic(self, dist: "Distribution", package_dir: Mapping[str, str]):
        ...
        obtained_dynamic.update(
            ...
            ifiers==self._obtain_classifiers(dist),
    ...
    def _obtain_entry_points(
        ...
        def _set_scripts(self, field: str, group: str):
            if group in groups:
...
@contextmanager
def _ignore_errors(self, ignore_option_errors: bool):
