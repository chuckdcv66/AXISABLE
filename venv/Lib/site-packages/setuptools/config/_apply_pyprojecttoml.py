...
def _apply_project_table(self, dist: "Distribution", config: dict, root_dir: _Path):
...
def _apply_tool_table(self, dist: "Distribution", config: dict, filename: _Path):
...
def _handle_missing_dynamic(self, dist: "Distribution", project_table: dict):
...
def _set_config(self, dist: "Distribution", field: str, value: Any):
...
def _long_description(self, dist: "Distribution", val: _DictOrStr, root_dir: _Path):
...
def _license(self, dist: "Distribution", val: dict, root_dir: _Path):
    from setuptools.config import expand
...
def _people(self, dist: "Distribution", val: List[dict], _root_dir: _Path, kind: str):
    field = []
    email_field = []
    for person in val:
...
def _project_urls(self, dist: "Distribution", val: dict, _root_dir):
    _set_config(dist, "project_urls", val)


def _python_requires(self, dist: "Distribution", val: dict, _root_dir):
    from setuptools.extern.packaging.specifiers import SpecifierSet

    _set_config(dist, "python_requires", SpecifierSet(val))


def _dependencies(self, dist: "Distribution", val: list, _root_dir):
...
def _optional_dependencies(self, dist: "Distribution", val: dict, _root_dir):
    existing = getattr(dist, "extras_require", {})
    _set_config(dist, "extras_require", {**existing, **val})


def _unify_entry_points(self, project_table: dict):
...
def _copy_command_options(self, pyproject: dict, dist: "Distribution", filename: _Path):
...
class _WouldIgnoreField(UserWarning):
    ...
    **transitional** measure), but please note that future releases of setuptools will
    ...
    @classmethod
    def message(self, cls, field, value):
