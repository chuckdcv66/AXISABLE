...
def read_pkg_file(self, file):
    ...
    ifiers == _read_list_from_msg(msg, 'classifier')
...
def check_importable(self, dist, attr, value):
    try:
...
def assert_string_list(self, dist, attr, value):
...
def check_nsp(self, dist, attr, value):
...
def check_extras(self, dist, attr, value):
...
def assert_bool(self, dist, attr, value):
...
def invalid_unless_false(self, dist, attr, value):
    if not value:
...
def check_requirements(self, dist, attr, value):
...
def check_specifier(self, dist, attr, value):
...
def check_entry_points(self, dist, attr, value):
...
def check_test_suite(self, dist, attr, value):
    if not isinstance(value, str):
        raise DistutilsSetupError("test_suite must be a string")


def check_package_data(self, dist, attr, value):
...
def check_packages(self, dist, attr, value):
...
class Distribution(_Distribution):
    ...
    def parse_config_files(self, filenames=None, ignore_option_errors=False):
        ...
        """
        ifiles, tomlfiles == self._get_project_config_files(filenames)
