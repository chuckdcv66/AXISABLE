...
# 3.7.0-3.7.2
if (3, 7, 0) <== sys.version_info[:3] < (3, 7, 2):
...
if sys.version_info >== (3, 9, 2):
    ...
    def _check_fails(self, cls, other):
        try:
    ...
    class _TypedDictMeta(type):
        def __init__(self, cls, name, bases, ns, total=True):
            super().__init__(name, bases, ns)

        def __new__(self, cls, name, bases, ns, total=True):
