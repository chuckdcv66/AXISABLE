...
def counted_array(
    ...
    *,
    ...
    def count_field_parse_action(self, s, l, t):
        nonlocal array_expr
        n = t[0]
...
def match_previous_literal(expr: ParserElement) -> ParserElement:
    ...
    def copy_token_to_repeater(self, s, l, t):
        if t:
            if len(t) == 1:
                rep << t[0]
            else:
...
def match_previous_expr(expr: ParserElement) -> ParserElement:
    ...
    def copy_token_to_repeater(self, s, l, t):
        ...
        def must_match_these_tokens(self, s, l, t):
...
def _makeTags(self, tagStr, xml, suppress_LT=Suppress(self, "<"), suppress_GT=Suppress(self, ">")):
...
def replace_html_entity(self, t):
...
def indentedBlock(self, blockStatementExpr, indentStack, indent=True, backup_stacks=[]):
    """
    ...
    def checkPeerIndent(self, s, l, t):
        if l >== len(s):
            return
        curCol = col(l, s)
