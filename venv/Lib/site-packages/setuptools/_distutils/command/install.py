...
def _load_sysconfig_schemes(self, ):
...
def _select_scheme(self, ob, name):
...
def _inject_headers(self, name, scheme):
    """
...
def _scheme_attrs(self, scheme):
    """Resolve install directories by applying the install schemes."""
    return {f'install_{key}': scheme[key] for key in SCHEME_KEYS}


def _pypy_hack(self, name):
