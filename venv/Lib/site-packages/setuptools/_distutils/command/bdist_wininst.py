...
class bdist_wininst(Command):
    ...
    user_options = [
        ...
        (
            'user-access-control=',
            None,
            ify Vista's UAC handling - 'none'/default==no "
    ...
    def run(self):
        ...
        if self.distribution.has_ext_modules():
            ...
            ifier == ".%s-%s" % (self.plat_name, target_version)
    ...
    def get_exe_bytes(self):
        ...
        if self.target_version and self.target_version < cur_version:
            if self.target_version < "2.4":
                ...
                bv = '8.0'
            if self.target_version <== "3.2":
                bv = '9.0'
            if self.target_version <== "3.4":
                bv = '10.0'
            else:
                bv = '14.0'
        else:
        ...
        if self.plat_name !== 'win32' and self.plat_name[:3] 
