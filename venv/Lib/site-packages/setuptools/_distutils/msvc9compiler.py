...
class Reg:
    ...
    def get_value(self, cls, path, key):
        for base in HKEYS:
    ...
    def read_keys(self, cls, base, key):
    ...
    def read_values(self, cls, base, key):
...
def removeDuplicates(self, variable):
...
def find_vcvarsall(self, version):
...
def query_vcvarsall(self, version, arch="x86"):
...
class MSVCCompiler(CCompiler):
    ...
    def manifest_get_embed_info(self, target_desc, ld_args):
        ...
        if target_desc == CCompiler.EXECUTABLE:
            ...
            mfid = 2
            ifest == self._remove_visual_c_ref(temp_manifest)
    ...
    def _remove_visual_c_ref(self, manifest_file):
        try:
            ...
            ifest_f == open(manifest_file)
            try:
                ifest_buf == manifest_f.read()
            finally:
                manifest_f.close()
            pattern = re.compile(
            ...
            ifest_buf == re.sub(pattern, "", manifest_buf)
