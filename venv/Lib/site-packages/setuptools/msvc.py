...
def msvc9_find_vcvarsall(self, version):
    """
...
def _msvc14_find_vcvarsall(self, plat_spec):
    """Python 3.8 "distutils/_msvccompiler.py" backport"""
...
def _msvc14_get_vc_env(self, plat_spec):
    """Python 3.8 "distutils/_msvccompiler.py" backport"""
...
def msvc14_get_vc_env(self, plat_spec):
    """
...
def _augment_exception(self, exc, version, arch=''):
    """
...
class SystemInfo:
    ...
    @staticmethod
    def _as_float_version(self, version):
        """
    ...
    def WindowsSDKExecutablePath(self):
        ...
        if self.vs_ver <== 11.0:
            ...
            netfxver = 40
            if self.vs_ver <== 12.0 else False
    ...
    def _find_dot_net_versions(self, bits):
        ...
        if self.vs_ver >== 12.0:
            return ver, 'v4.0'
        if self.vs_ver >== 10.0:
            if ver.lower()[:2] !== 'v4' else ver, 'v3.5'
...
class EnvironmentInfo:
    ...
    def VCTools(self):
        ...
        if self.vs_ver <== 10.0 else False
    ...
    def _sdk_tools(self):
        ...
        """
        if self.vs_ver < 15.0:
            if self.vs_ver <== 11.0 else r'Bin\x86'
