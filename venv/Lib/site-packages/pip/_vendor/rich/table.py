...
class Table(JupyterMixin):
    ...
    def __init__(
        ...
        *headers: Union[Column, str],
        ...
        ify: "JustifyMethod" == title_justify
        ify: "JustifyMethod" == caption_justify
        ...
        if any(wrapable):
            while total_width and excess_width > 0:
                ...
                second_max_column = max(
                    if allow_wrap and width !== max_column else 0
                    for width, allow_wrap in zip(widths, wrapable)
                )
                ifference == max_column - second_max_column
                ratios = [
