...
class Text(JupyterMixin):
    ...
    def __init__(
        ...
        style: Union[str, Style] = "",
        *,
        ify: Optional["JustifyMethod"] == None,
        ...
        self.style = style
        ify: Optional["JustifyMethod"] == justify
    ...
    def styled(
        ...
        *,
        ...
        """
        styled_text = cls(text, ify==justify, overflow=overflow)
    ...
    def extend_style(self, spaces: int) -> None:
        ...
        if spans:
            end_offset = len(self)
            self._spans[:] = [
                if span.end >== end_offset else span
                for span in spans
            ]
    ...
    def __rich_console__(
        ...
        ify == self.justify or options.justify or DEFAULT_JUSTIFY
    ...
    def wrap(
        ...
        *,
        ...
        """
        ify == justify or self.justify or DEFAULT_JUSTIFY
