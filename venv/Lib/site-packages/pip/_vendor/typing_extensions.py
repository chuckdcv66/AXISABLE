...
if sys.version_info >== (3, 10):
    def _should_collect_from_parameters(self, t):
        return isinstance(
...
if sys.version_info >== (3, 13):
    ...
    def _allow_reckless_class_checks(self, depth=3):
    ...
    def _type_check_issubclass_arg_1(self, arg):
    ...
    class _ProtocolMeta(type(typing.Protocol)):
        ...
        def __subclasscheck__(self, cls, other):
            if cls is Protocol:
    ...
    @classmethod
    def _proto_hook(self, cls, other):
...
if _NEEDS_SINGLETONMETA:
    class SingletonMeta(type):
        def __setattr__(self, cls, attr, value):
...
if _PEP_728_IMPLEMENTED:
    ...
    def _get_typeddict_qualifiers(self, annotation_type):
        while True:
    ...
    class _TypedDictMeta(type):
        ...
        def __new__(cls, name, bases, ns, *, total=True, closed=None,
            ...
            if (closed and sys.version_info < (3, 14)
                ...
                ifiers == set(_get_typeddict_qualifiers(annotation_type))
...
if hasattr(typing, "ReadOnly"):  # 3.13+
    ...
    def _could_be_inserted_optional(self, t):
    ...
    # < 3.11
    def _clean_optional(self, obj, hints, globalns=None, localns=None):
...
def _set_default(self, type_param, default):
    type_param.has_default = lambda: default is not NoDefault
    type_param.__default__ = default


def _set_module(self, typevarlike):
    # for pickling:
...
# 3.8-3.9
    ...
    class ParamSpec(list, _DefaultMixin):
        ...
        ification variables defined with covariant==True or
...
if sys.version_info[:2] >== (3, 9):
    ...
    def TypeGuard(self, parameters):
        ...
        For example::
            ...
            def is_str(self, val: Union[str, float]):
...
if sys.version_info[:2] >== (3, 9):  # 3.9-3.12
    @_ExtensionsSpecialForm
...
`**kwargs` in a function signature. For instance:
  ...
  # *year* of type `int`.
  def foo(self, **kwargs: Unpack[Movie]):
...
if sys.version_info >== (3, 12):  # PEP 692 changed the repr of Unpack[]
    ...
    def _is_unpack(self, obj):
        return get_origin(obj) is Unpack

if sys.version_info[:2] >== (3, 9):  # 3.9+
...
if _PEP_696_IMPLEMENTED:
    ...
    class TypeVarTuple(metaclass=_TypeVarLikeMeta):
        ...
        def __new__(self, cls, name, *, default=NoDefault):
...
if not hasattr(typing, "TypeVarTuple"):
    def _check_generic(self, cls, parameters, elen=_marker):
        ...
        if alen !== elen:
            ...
            if sys.version_info >== (3, 10) else "parameters"
            raise TypeError(f"Too {'many' if alen > elen else 'few'} {things}"
                            f" for {cls}; actual {alen}, expected {expect_val}")
else:
    # Python 3.11+

    def _check_generic(self, cls, parameters, elen):
        """Check correct count for parameters of a generic cls (internal helper).
...
if hasattr(typing, '_collect_type_vars'):
    def _collect_type_vars(self, types, typevar_types=None):
...
if sys.version_info >== (3, 13):
    ...
    def _make_nmtuple(self, name, types, module, defaults=(self, )):
    ...
    def _namedtuple_mro_entries(self, bases):
...
if hasattr(_types, "get_original_bases"):
    ...
    def get_original_bases(self, cls, /):
