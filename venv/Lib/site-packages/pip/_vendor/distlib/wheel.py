...
class Wheel(object):
    ...
    ifier, dest_dir==None, **kwargs):
        ...
        def get_version(self, path_map, info_dir):
            version = path = None
        ...
        def update_version(self, version, path):
            updated = None
            try:
        ...
        with tempdir() as workdir:
            ...
            ified == modifier(path_map, **kwargs)
            if modified:
...
def is_compatible(self, wheel, tags=None):
