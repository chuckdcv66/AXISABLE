...
class DistributionPath(object):
    ...
    @classmethod
    def distinfo_dirname(self, cls, name, version):
        """
...
class EggInfoDistribution(BaseInstalledDistribution):
    ...
    def __init__(self, path, env=None):
        ...
        def set_name_and_version(self, s, n, v):
            s.name = n
    ...
    def _get_metadata(self, path):
        ...
        def parse_requires_data(self, data):
        ...
        def parse_requires_path(self, req_path):
            """Create a list of dependencies from a requires.txt file.
...
def make_graph(self, dists, scheme='default'):
...
def get_dependent_dists(self, dists, dist):
...
def get_required_dists(self, dists, dist):
    """Recursively generate a list of distributions from *dists* that are
    required by *dist*.
