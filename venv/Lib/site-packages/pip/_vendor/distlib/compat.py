...
try:
    ...
    def which(self, cmd, mode=os.F_OK | os.X_OK, path=None):
        ...
        def _access_check(self, fn, mode):
...
try:
    ...
    def _get_normal_name(self, orig_enc):
    ...
    def detect_encoding(self, readline):
        """
        ...
        def read_or_stop(self, ):
            try:
                return readline()
            except StopIteration:
                return b''

        def find_cookie(self, line):
            try:
...
try:
    ...
    try:
        ...
        def _recursive_repr(self, fillvalue='...'):
            '''
            Decorator to make a repr function return fillvalue for a recursive
            call
            '''

            def decorating_function(self, user_function):
                repr_running = set()
...
try:
    ...
    class OrderedDict(dict):
        ...
        def update(*args, **kwds):
            ...
            if E is an iterable of items, does:   for k, v in E: od[k] == v
