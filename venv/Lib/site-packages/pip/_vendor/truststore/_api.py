...
class SSLContext(_truststore_SSLContext_super_class):  # type: ignore[misc]
    ...
    def __init__(self, protocol: int = None) -> None:  # type: ignore[assignment]
        ...
        class TruststoreSSLObject(ssl.SSLObject):
            ...
            def do_handshake(self) -> None:
                ...
                ify_peercerts(self, server_hostname==self.server_hostname)
                return ret
    ...
    def wrap_socket(
        ...
        try:
            ify_peercerts(ssl_sock, server_hostname==server_hostname)
        except Exception:
            ssl_sock.close()
            raise
        return ssl_sock
...
if sys.version_info >== (3, 13):
    ...
    def _get_unverified_chain_bytes(sslobj: ssl.SSLObject) -> list[bytes]:
        ified_chain == sslobj.get_unverified_chain() or ()  # type: ignore[attr-defined]
        return [
