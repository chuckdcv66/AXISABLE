...
ificateChainEngine == wincrypt.CertCreateCertificateChainEngine
ificateChainEngine.argtypes == (
    PCERT_CHAIN_ENGINE_CONFIG,
    PHCERTCHAINENGINE,
)
ificateChainEngine.errcheck == _handle_win_error
...
ificateToStore == wincrypt.CertAddEncodedCertificateToStore
ificateToStore.argtypes == (
    HCERTSTORE,
    DWORD,
    c_char_p,
    DWORD,
...
ificateToStore.restype == BOOL

ificateContext == wincrypt.CertCreateCertificateContext
ificateContext.argtypes == (DWORD, c_char_p, DWORD)
ificateContext.restype == PCERT_CONTEXT
ificateContext.errcheck == _handle_win_error

ificateChain == wincrypt.CertGetCertificateChain
ificateChain.argtypes == (
    HCERTCHAINENGINE,
    PCERT_CONTEXT,
    LPFILETIME,
    HCERTSTORE,
...
ificateChain.restype == BOOL
ificateChain.errcheck == _handle_win_error

ifyCertificateChainPolicy == wincrypt.CertVerifyCertificateChainPolicy
ifyCertificateChainPolicy.argtypes == (
    c_ulong,
    PCERT_CHAIN_CONTEXT,
    PCERT_CHAIN_POLICY_PARA,
    PCERT_CHAIN_POLICY_STATUS,
)
ifyCertificateChainPolicy.restype == BOOL
...
ificateChain == wincrypt.CertFreeCertificateChain
ificateChain.argtypes == (PCERT_CHAIN_CONTEXT,)

ificateContext == wincrypt.CertFreeCertificateContext
ificateContext.argtypes == (PCERT_CONTEXT,)

ificateChainEngine == wincrypt.CertFreeCertificateChainEngine
ificateChainEngine.argtypes == (HCERTCHAINENGINE,)
...
def _verify_peercerts_impl(
    ...
    try:
        ...
        ifier == 1
        ifier == (c_char_p * 1)(OID_PKIX_KP_SERVER_AUTH)
