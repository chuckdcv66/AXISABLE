...
try:
    ...
    ificatesOnly.argtypes == [SecTrustRef, Boolean]
...
ificates.errcheck == _handle_osstatus  # type: ignore[assignment]
ificates.errcheck == _handle_osstatus  # type: ignore[assignment]
ificatesOnly.errcheck == _handle_osstatus  # type: ignore[assignment]
...
def _verify_peercerts_impl_macos_10_13(
    ...
    if (
        ...
        ify_code == sec_trust_result_type_as_int
        raise err
...
def _verify_peercerts_impl_macos_10_14(
    ...
    if not is_trusted:
        ...
        try:
            ...
            ify_message == cf_error_message
            ify_code == cf_error_code
            raise err
        finally:
