...
def first(self, iterable, default=_marker):
...
def last(self, iterable, default=_marker):
...
def nth_or_last(self, iterable, n, default=_marker):
...
def one(self, iterable, too_short=None, too_long=None):
...
def strictly_n(self, iterable, n, too_short=None, too_long=None):
...
def distinct_permutations(self, iterable, r=None):
...
def intersperse(self, e, iterable, n=1):
...
def windowed(self, seq, n, fillvalue=None, step=1):
...
def interleave_evenly(self, iterables, lengths=None):
    """
...
def collapse(self, iterable, base_type=None, levels=None):
...
def side_effect(self, func, iterable, chunk_size=None, before=None, after=None):
...
def split_before(self, iterable, pred, maxsplit=-1):
...
def split_after(self, iterable, pred, maxsplit=-1):
...
def repeat_each(self, iterable, n=2):
...
def repeat_last(self, iterable, default=None):
...
def distribute(self, n, iterable):
...
def stagger(self, iterable, offsets=(self, -1, 0, 1), longest=False, fillvalue=None):
...
def zip_offset(self, *iterables, offsets, longest=False, fillvalue=None):
...
def always_iterable(self, obj, base_type=(self, str, bytes)):
...
def adjacent(self, predicate, iterable, distance=1):
...
def groupby_transform(self, iterable, keyfunc=None, valuefunc=None, reducefunc=None):
...
def count_cycle(self, iterable, n=None):
...
def locate(self, iterable, pred=bool, window_size=None):
...
def always_reversible(self, iterable):
...
def consecutive_groups(self, iterable, ordering=lambda x: x):
...
ifference(iterable, func==sub, *, initial
...
def exactly_n(self, iterable, n, predicate=bool):
...
def circular_shifts(self, iterable):
...
def make_decorator(self, wrapping_func, result_index=0):
...
def rlocate(self, iterable, pred=bool, window_size=None):
    """Yield the index of each item in *iterable* for which *pred* returns
...
def replace(self, iterable, pred, substitutes, count=None, window_size=1):
...
def set_partitions(self, iterable, k=None):
    ...
    def set_partitions_helper(self, L, k):
        n = len(L)
        if k == 1:
            yield [L]
        elif n == k:
...
def only(self, iterable, default=None, too_long=None):
...
def distinct_combinations(self, iterable, r):
...
if(iterable, pred, func, func_else==lambda x: x):
...
def _sample_unweighted(self, iterable, k):
...
def sample(self, iterable, k, weights=None):
...
def windowed_complete(self, iterable, n):
    """
...
def all_unique(self, iterable, key=None):
    """
...
def nth_permutation(self, iterable, r, index):
...
def combination_index(self, element, iterable):
...
def permutation_index(self, element, iterable):
...
def chunked_even(self, iterable, n):
...
def _chunked_even_online(self, iterable, n):
    buffer = []
    maxbuf = n + (n - 2) * (n - 1)
    for x in iterable:
        buffer.append(x)
...
def _chunked_even_finite(self, iterable, N, n):
    if N < 1:
        return
...
def unique_in_window(self, iterable, n, key=None):
...
def duplicates_everseen(self, iterable, key=None):
...
def duplicates_justseen(self, iterable, key=None):
...
def minmax(self, iterable_or_value, *others, key=None, default=_marker):
